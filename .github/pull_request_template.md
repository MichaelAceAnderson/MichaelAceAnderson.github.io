...
Pour faire une Pull request, vous devez cocher toutes les cases en remplaçant `[ ]` par `[X]` ci-dessous :

- [ ] J'ai lu [CONTRIBUTING.md](/CONTRIBUTING.md) avant de faire mes modifications
...
Au cas où les noms de mes commits ne suffisent pas à expliquer les modifications, voici quelques informations supplémentaires :
