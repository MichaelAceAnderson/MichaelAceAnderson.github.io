<?php include_once STRUCTURE_DIR . '/head.php'; ?>
<style>
	:root {
...
if (isset($_SERVER)) {
	echo '<b>Valeurs de SERVER: </b><span>' . preg_replace($formatting[0], $formatting[1], print_r($_SERVER, true)) . '</span><br>';
}
if (isset($_GET)) {
	echo '<b>Valeurs de GET: </b><span>' . preg_replace($formatting[0], $formatting[1], print_r($_GET, true)) . '</span><br>';
}
if (isset($_ENV)) {
...
// URL Complète
echo '<b>Full URL: </b><span>' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'] . '</span><br>';
