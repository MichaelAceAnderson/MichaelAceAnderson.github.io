...
<section class="main" id="main">
    ...
    <div class="content">
        ...
        <article>
            ...
            <p>
                Projet réalisé en cours de formation, permet la gestion de portefeuilles contenant des comptes clients
                (courant & épargne).
        ...
        <article>
            ...
            <p>
                Mini-CMS créé à l'âge de 14 ans permettant de créer un blog (obsolète, fonctionne sans base de données
        ...
        <article>
            ...
            <p>
                Site réalisé à l'âge de 14 ans destiné au partage de plugins Minecraft traduits, disposant d'une
                interface admin d'upload et d'une interface de commentaires.
                <span class="tags">#HTML #CSS #PHP</span>
            </p>
        </article>
    </div>
